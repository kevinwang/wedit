 ...
 * @author owner
 */
public class WEditUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WEditUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
